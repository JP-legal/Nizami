...
{{
  ...
  "citations": [
    {{
      ...
      "article_or_clause": "Article or clause number",
...
- The answer MUST include legal references directly in the text, for example:
  "وفقًا للمادة 5 من نظام تملك غير السعوديين للعقار [1]..."
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("prompts", "0010_fix_legal_advice_prompt_escape_braces"),
    ]
